...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/2.9.10/iOS-FireblocksSDK.zip", checksum: "e69d5ffb6e42159f590eb0e9f73319b80a283a28e78ce2e7bc244370a9e69a2b"),
