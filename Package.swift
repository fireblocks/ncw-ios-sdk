...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/2.9.8/iOS-FireblocksSDK.zip", checksum: "79aa02ff601894c2eb25f0bd60ceb5983a9d457a09711022ee31ccbf2919fd44"),
