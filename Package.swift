...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/2.5.0/iOS-FireblocksSDK.zip", checksum: "bd178a4da1189623c71c5148ef2971746d5c915e7ecca76c75def134252d0b79"),
