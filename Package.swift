...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/1.0.4/iOS-FireblocksSDK.zip", checksum: "69a2b2d8d1eea3caa43e59ea20c4f2f8bd328c8be705beb27713c3af560439df"),
