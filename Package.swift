...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/2.5.1/iOS-FireblocksSDK.zip", checksum: "0be8c5ddf1898338cbb64badfdea2fe5dfae0ffb076b7d4b78952e71cd23541b"),
