...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "FireblocksSDK", url: "https://github.com/fireblocks/ncw-ios-sdk/releases/download/2.5.0/iOS-FireblocksSDK.zip", checksum: "0619d003343fc8ac43a5f72a7e9562de4cb92637b8ef9c2fd4ff49b7278c17d6"),
